...
#define ICON_FILE "/usr/share/microninja-settings/settings-widget.png"
#define KEYBOARD_ICON "/usr/share/microninja-settings/media/Icons/Icon-Keyboard.png"
#define MOUSE_ICON "/usr/share/microninja-settings/media/Icons/Icon-Mouse.png"
#define AUDIO_ICON "/usr/share/microninja-settings/media/Icons/Icon-Audio.png"
#define DISPLAY_ICON "/usr/share/microninja-settings/media/Icons/Icon-Display.png"
#define WIFI_ICON "/usr/share/microninja-settings/media/Icons/Icon-WiFi.png"

#define SETTINGS_CMD "sudo microninja-settings "
...
static GtkWidget *plugin_constructor(LXPanel *panel, config_setting_t *settings)
{
    ...
    gtk_tooltips_set_tip(tooltips, GTK_WIDGET(icon), _("Microninja Settings"), NULL);
...
void settings_clicked(GtkWidget* widget, const char* state)
{
    ...
    strcat(cmd, state);
    launch_cmd(cmd, "microninja-settings");
    /* Play sound */
...
static gboolean show_menu(GtkWidget *widget, GdkEventButton *event)
{
    ...
    /* Display button */
    GtkWidget* display_item = gtk_image_menu_item_new_with_label(_("Screen"));
    ...
    /* All button */
    GtkWidget* all_item = gtk_image_menu_item_new_with_label(_("Settings"));
...
FM_DEFINE_MODULE(lxpanel_gtk, microninja_settings)

/* Plugin descriptor. */
LXPanelPluginInit fm_module_init_lxpanel_gtk = {
    .name = "Microninja Settings",
    .description = "A quick access to important settings.",
