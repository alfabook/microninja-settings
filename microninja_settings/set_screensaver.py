...
from microninja_settings.templates import Template, ScrolledWindowTemplate
...
from microninja_settings.system.screensaver import (
    is_screensaver_on, get_screensaver_timeout, set_screensaver_timeout,
    set_screensaver_program
)

screensaver_path = "/usr/share/microninja-settings/media/ScreensaverIcons"
...
class SetScreensaverAdvanced(Template):
    ...
    def __init__(self, win):
        ...
        label = Gtk.Label(_('Enable screensaver'))
        ...
        label = Gtk.Label(_("Choose the minutes\nbefore the start of the screensaver"))
        label.get_style_context().add_class('checkbutton_label')
