...
from microninja_settings.config_file import get_setting, set_setting, file_replace
from microninja_settings.boot_config import set_config_value
...
try:
    from microninja_settings.system.display import get_edid
...
def is_HDMI():
    ...
    # Default to Analogue
        ...
        # Make sure config file is up to date
        if get_setting('Audio') != 'Analog':
            set_setting('Audio', "Analog")
        return False
