...
from microninja.network import KwifiCache, connect
...
class ConnectToNetwork():
    ...
    def _connect_to_network(self):
        title = _("Connect to") + " {}".format(self._network_name)
    ...
    def _fail_screen(self, win):
        ...
        description = _("Perhaps the signal was too weak to connect.")
        buttons = [
            {
                "label": ""
            },
    ...
    def _success_screen(self):
        self._win.remove_main_widget()
        title = _("Success")
        description = _("You are connected")
        buttons = [
            {
                "label": "OK",
                "type": "KanoButton",
    ...
    def _launch_connect_thread(self):
        logger.debug('Connessione a {}'.format(self._network_name))
...
def _connect_thread_(wiface, network_name, passphrase, encryption,
    ...
    logger.debug(
        'Connessione a {} {} {}. Con successo: {}'.format(
