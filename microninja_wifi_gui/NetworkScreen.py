...
from microninja_wifi_gui.WhiteButton import WhiteButton
from microninja.gtk3.cursor import attach_cursor_events
from microninja_wifi_gui.misc import tick_icon
from microninja_wifi_gui.paths import img_dir
from microninja_wifi_gui.PasswordScreen import PasswordScreen
from microninja_wifi_gui.Template import Template
from microninja.network import is_connected, disconnect
from microninja_wifi_gui.ConnectToNetwork import ConnectToNetwork
...
class NetworkScreen(Gtk.Box):
    ...
    def _create_network_box(self, network_list):
        ...
        if not len(network_list):
            no_networks_label = Gtk.Label(_("No network found!"))
    ...
    def _create_refresh_connect_buttons(self):
        ...
        self._connect_btn = KanoButton(_('CHOOSE'))
    ...
    def _set_connect_btn_status(self, connect=True):
        ...
        if connect:
            ...
            self._connect_btn.set_label(_("CHOOSE"))
    ...
    def _disconnect_screen(self):
        ...
        title = _("Disconnection completed.")
        description = _("You are offline")
        buttons = [
            {
                "label": _("CLOSE"),
                "type": "KanoButton",
